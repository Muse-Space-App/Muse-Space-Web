  ...
  return (
    <AuthProvider>
      <NotificationProvider>
        {isAuthRoute ? (
          <main className="min-h-screen w-full flex items-center justify-center p-4 bg-[url('https://res.cloudinary.com/dzpv8dz7e/image/upload/v1780888547/rrxgc4xrzgk3rtnpcytz.jpg')] bg-cover bg-center relative">
